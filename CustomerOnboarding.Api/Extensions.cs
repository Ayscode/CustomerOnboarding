...
using CustomerOnboarding.Repositories;
...
namespace CustomerOnboarding
{
    public static class Extensions
    {
        ...
        {
            services.AddDbContext<ApplicationDbContext>(o => o.UseSqlServer(configuration.GetConnectionString("CustomerOnboardingConnectionString")), ServiceLifetime.Transient);
        ...
        public static void ConfigureSettings(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.Configure<WemaAPISettings>(configuration.GetSection("WemaAPISettings"));
