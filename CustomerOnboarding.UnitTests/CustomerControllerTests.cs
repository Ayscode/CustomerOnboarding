...
// using CustomerOnboarding.Controllers;
...
//     {
//         // Arrange
//         var authService = new AuthService(_context.Object, _userManager.Object, Options.Create(_jwtSettings), _refreshTokenGenerator.Object, _signInManager.Object, _logger.Object, Options.Create(_appSettings));
//         string validPhoneNumber = "08123456789";

//         // Act
//         var result = await authService.SendOtp(validPhoneNumber);
...
//         // Act and Assert
//         await Assert.ThrowsAsync<BadRequestException>(async () => await authService.SendOtp(invalidPhoneNumber));
//     }
